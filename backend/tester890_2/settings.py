"""
Django settings for tester890_2 project.
...
WSGI_APPLICATION = 'tester890_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tester890_2 API",
    "DESCRIPTION": "API documentation for tester890_2 App",
    "VERSION": "v1",
}
